...
let todo = []; // deklarasi variable todo, masukan data jika ada data jika data array kosong
...
// fungsi done untuk melakukan perubahan atau penetapan data dan menampilkan ulang data tersebut
